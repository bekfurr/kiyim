          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                name="role"
                required
                className="block w-full rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-900 px-3 py-2 text-gray-900 dark:text-white focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
              >
                <option value="buyer">Mijoz (Xaridor)</option>
                <option value="seller">Sotuvchi (Do'kon ochish)</option>
              </select>
            </div>
          </div>
