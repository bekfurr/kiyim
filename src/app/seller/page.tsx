  ...
  return (
    <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-gray-100">
      ...
      <form action={saveStore} className="space-y-6 max-w-2xl">
        <div>
          <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-1">Do'kon nomi</label>
          <input
            id="name"
            name="name"
            type="text"
            ...
            className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-blue-500 focus:ring-blue-500 outline-none"
          />
        </div>
        
        <div>
          <label htmlFor="description" className="block text-sm font-medium text-gray-700 mb-1">Tavsif</label>
          <textarea
            id="description"
            name="description"
            rows={4}
        ...
        <div>
          <label htmlFor="delivery_options" className="block text-sm font-medium text-gray-700 mb-1">Yetkazib berish opsiyalari</label>
          <select
            id="delivery_options"
        ...
        <div>
          <label htmlFor="location" className="block text-sm font-medium text-gray-700 mb-1">Do'kon manzili</label>
          <input
            id="location"
            name="location"
            type="text"
