...
export default function NewProduct() {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-sm border border-gray-100 max-w-2xl">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Yangi maxsulot qo'shish</h1>
