  ...
  return (
    <div className="bg-white dark:bg-slate-800/50 rounded-2xl p-6 sm:p-10 shadow-sm border border-gray-100 dark:border-slate-700">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Maxsulotlar</h1>
        <Link
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-gray-200 dark:border-slate-700">
              <th className="py-3 px-4 font-semibold text-gray-600 dark:text-gray-400">Rasm</th>
              <th className="py-3 px-4 font-semibold text-gray-600 dark:text-gray-400">Nomi</th>
              <th className="py-3 px-4 font-semibold text-gray-600 dark:text-gray-400">Narxi</th>
              <th className="py-3 px-4 font-semibold text-gray-600 dark:text-gray-400 text-right">Amallar</th>
            </tr>
          </thead>
          <tbody>
            {products?.length === 0 ? (
              ...
              products?.map((product) => (
                <tr key={product.id} className="border-b border-gray-100 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-700/50">
                  <td className="py-3 px-4">
                    <div className="h-12 w-12 rounded bg-gray-100 dark:bg-slate-900 relative overflow-hidden">
                      {product.image_url && (
                  ...
                  <td className="py-3 px-4 text-blue-600 dark:text-blue-400 font-medium">{product.price.toLocaleString("uz-UZ")} so'm</td>
